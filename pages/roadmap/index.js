...
export default function Roadmap() {
    return (
        <>
            <div className="pl-5 xl:pl-40 xl:pr-40  mb-20">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 justify-between md:text-center 
                  mt-10 md:text-xs ">
                    ...
                    <div className="  lg:text-center border-l md:border-l-0 py-10  ">
                        ...
                        <div className="rounded-full shadow-lg ring-8 bg-yellow-400  w-4 h-4 -ml-2 md:hidden" />
                    ...
                    <div className="  lg:text-center border-l md:border-l-0  py-10 ">
                        ...
                        <ul className="list-none mx-10 lg:mx-[80px] text-sm mt-5 md:hidden">
                            <li>NFT Mint platform Development.</li>
                            <li>LSN Seed Program launch.</li>
                            <li>FILM NODE NFT launch for a decentralised platform.</li>
                    ...
                    <div className="  lg:text-center border-l md:border-l-0  py-10 ">
                        ...
                        <ul className="list-none mx-10 lg:mx-14 text-sm mt-5 md:hidden">
                            <li>First premium NFT reveal and marketing.</li>
                            <li>First premium limited NFT launch.</li>
                            ...
                            <li>Grand get together On completion of sell of second premium limited NFT for holder in Dubai
                                ( condition apply)
                                .</li>
                    ...
                    <div className="  lg:text-center border-l md:border-l-0 py-10  ">
                        ...
                        <ul className="list-none mx-10 lg:mx-0 text-sm mt-5 md:hidden">
                            ...
                            <li>Bringing 100+ projects on the LSN platform by the end of phase-4.</li>
                            <li>White paper V.2</li>
