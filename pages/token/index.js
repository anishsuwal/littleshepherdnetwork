...
export default function Token() {
    return (
        <section id="token" className=" pt-28">
                ...
                <div className="flex flex-col justify-center  opacity-85  mb-20">
                    <div><h1 className="text-2xl md:text-5xl text-center font-semibold">Tokenomics </h1></div>
